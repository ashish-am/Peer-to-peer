...
<body>
    ...
    <div id="page">
        ...
        <div id="main-content" style="background-color:inherit;">
            <div id="myHeader">
                <button style="color: black;border-radius: 15px;font-size: 52px; ;position: relative;left: 25%;font-weight: bolder;margin-bottom: 50px;">Your Transaction History</button>
            </div>
            <div id="main-options">
                <div id="modal">
                    <div class="question">
